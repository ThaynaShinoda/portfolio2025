...
export function AboutMe() {
  return (
    <div id="aboutme" className={styles.aboutContainer}>
      <h4 className={`${styles.title} ${styles.autoShow}`}>Sobre mim</h4>
      <p className={`${styles.text} ${styles.autoShow}`}>
      ...
      <h4 className={`${styles.title} ${styles.autoShow}`}>Minha trajetória</h4>
      <p className={`${styles.text} ${styles.autoShow}`}>
      ...
      <h4 className={`${styles.title} ${styles.autoShow}`}>Curiosidades</h4>
      <p className={`${styles.text} ${styles.autoShow}`}>
