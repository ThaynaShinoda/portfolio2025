    ...
    <section className={styles.skillsSection}>
      ...
      <div className={styles.content}>
        <div className={styles.text}>
          <p>
            Ao longo da minha formação como desenvolvedora, tenho focado principalmente em tecnologias Front-end, com maior domínio em HTML, CSS, JavaScript e React. Essas ferramentas são a base dos meus projetos e onde me sinto mais confortável para criar interfaces funcionais e acessíveis.
          </p>
          <p>
